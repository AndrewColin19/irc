...
SRCS=	srcs/Server.cpp srcs/main.cpp srcs/Commands/Command.cpp \
		...
		srcs/Commands/CommandJoin.cpp srcs/Commands/CommandPrivmsg.cpp srcs/Commands/CommandOper.cpp srcs/Commands/CommandPart.cpp srcs/Commands/CommandNames.cpp srcs/Commands/CommandList.cpp
OBJS= $(SRCS:.cpp=.o)
